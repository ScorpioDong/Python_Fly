...
void Drv_Uart2Init(uint32_t baudrate)
{
	...
	/*使能UART0接收中断*/			
	UARTIntRegister(UART0_BASE,UART2_IRQHandler);			
...
{
	while( (U2TxOutCnt != U2TxInCnt) && (ROM_UARTCharPutNonBlocking(UART0_BASE,U2TxDataTemp[U2TxOutCnt])) )
		U2TxOutCnt++;
}
/////////////////////////////////////////////////////////////////////////////////////////////////
u8 U1TxDataTemp[256];
...
void Drv_Uart1Init(uint32_t baudrate)
{
	...
	/*使能UART0接收中断*/			
	UARTIntRegister(UART4_BASE,UART1_IRQHandler);			
...
{
	while( (U1TxOutCnt != U1TxInCnt) && (ROM_UARTCharPutNonBlocking(UART4_BASE,U1TxDataTemp[U1TxOutCnt])) )
		U1TxOutCnt++;
}
/////////////////////////////////////////////////////////////////////////////////////////////////
u8 U3TxDataTemp[256];
