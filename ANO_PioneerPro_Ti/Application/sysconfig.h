...
#define LED2_SYSCTL			SYSCTL_PERIPH_GPIOF
#define LED3_SYSCTL			SYSCTL_PERIPH_GPIOF
//#define LEDS_SYSCTL			SYSCTL_PERIPH_GPIOF
#define LED1_PORT			GPIOF_BASE
#define LED2_PORT			GPIOF_BASE
#define LED3_PORT			GPIOF_BASE
